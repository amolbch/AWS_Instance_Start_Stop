...
def lambda_handler(event, context):
    ...
    for instance in instances:
        ...
        #        vol_id, instance['InstanceId'])
            ...
            AMIid = ec.create_image(InstanceId=instance['InstanceId'], Name="Sambandh-ProductionLambda - " + instance['InstanceId'] + " from " + create_fmt, Description="Lambda created AMI of instance " + instance['InstanceId'] + " from " + create_fmt, NoReboot=True, DryRun=False)
